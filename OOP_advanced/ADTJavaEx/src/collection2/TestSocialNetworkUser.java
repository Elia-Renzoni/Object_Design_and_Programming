...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String... args) {
        ...
        mgladwell = new SocialNetworkUserImpl("Malcom", "Gladwell", "mgladwell", 54);
        kbacon = new SocialNetworkUserImpl("Kevin", "Bacom", "kbacon", 56);
        dwashington = new SocialNetworkUserImpl("Denzel", "Washington", "dwashington", 59);
        ntaleb = new SocialNetworkUserImpl("Nicholas", "Taleb", "ntaleb", 54);
