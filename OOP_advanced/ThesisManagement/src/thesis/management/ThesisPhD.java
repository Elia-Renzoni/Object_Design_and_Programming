...
public class ThesisPhD extends Thesis {
    private final String classDegree;

    public ThesisPhD(final String title, final String author, final int date, final ThesisState state, final String supervisor, final String classDegree) {
