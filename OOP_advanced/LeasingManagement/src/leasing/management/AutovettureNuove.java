...
public class AutovettureNuove implements Autovetture {
	private String numeroTarga;
	private String tipoAutovettura;
	private double chilometraggio;
	private int autonomia;
	
	public AutovettureNuove(String numeroTarga, String tipoAutovettura, double chilometraggio, int autonomia) {
